...
def load_config():
    ...
    if not os.path.exists(CONFIG_FILE):
        ...
        print("   請複製 tsmc_config.example.json 為 tsmc_config.json 並填入資料")
...
<head>
  ...
  <style>
    ...
    .header   {{ background:#1a3a5c; color:#fff; padding:22px 20px; text-align:center; }}
    ...
    .section h3{{ margin:0 0 12px; font-size:15px; color:#1a3a5c; }}
